...
const { verifyLogin, verifyPackage, verifyAdmin, verifyCheckAttemptTest } = require('../midlewares/verify');
const router = express.Router();

// Test API endpoint

router.get("/", getAllQuestion);
router.get("/:examId", verifyLogin, verifyPackage, verifyCheckAttemptTest, getQuestionByExam);
